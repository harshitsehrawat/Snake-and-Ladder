...
def plent():
        ...
        def t1():
            ...
            if tur == 1:
                ...
                if u == 6:
                    ...
                    l1.destroy()
                    can.destroy()
                    v = Label(w, image=vr, bg='#151c2f');
                    w.configure(background='#151c2f')
                    v.pack()
                ...
                if u == 1:
                    ...
                    return 0
                u = SnL(u, 44, 95, (px - (70 * 6), py - (70 * 9)), p)
                ...
                u = SnL(u, 37, 87, (px - (70 * 7), py - (70 * 8)), p)
                u = SnL(u, 38, 20, (px - (70 * 1), py - (70 * 1)), p)
                if d1 == 6:
                    d1 = random.randint(1, 6)
                    l1.destroy()
                    if d1 == 1:
            ...
            # for d2
                ...
                if g == 1:
                    ...
                    v.pack()
                    return 0
                g = SnL(g, 44, 95, (kx - (70 * 6), ky - (70 * 9)), k)
                ...
                g = SnL(g, 37, 87, (kx - (70 * 7), ky - (70 * 8)), k)
                g = SnL(g, 38, 20, (kx - (70 * 1), ky - (70 * 1)), k)
                if d2 == 6:
                    d2 = random.randint(1, 6)
                    l2.destroy()
                    if d2 == 1:
            ...
            if tur == 2:
                if pln == 1:
                    ...
                    a1 = Button(w, text='roll', height=5, width=20, command=t1, font=("Helvetica", 16),
                                background='White', padx=10, pady=10)
                    a1.pack(side=RIGHT)
            elif tur == 1:
                a1 = Button(w, text='roll', height=5, width=20, command=t1, font=("Helvetica", 16), background='White',
                            padx=10, pady=10)
                a1.pack(side=RIGHT)
    else:
        ee = Entry(w, width=8, bd=5)
    ...
    l2.pack(side=BOTTOM)
    a1 = Button(w, text='roll', height=1, width=10, command=t1, font=("Helvetica", 16), background='White', padx=10,
                pady=10)
    a1.pack(side=RIGHT)


but = Button(w, text='enter', font=("Helvetica", 16), command=plent, width=10, height=1, background='White', padx=10,
             pady=10)
but.pack(side=RIGHT)
ee.pack(side=RIGHT)
te.pack(side=RIGHT)
